...
public class AptComponent {
    ...
    private AptDistribution distribution;

    public AptComponent() {
    }

    public AptComponent( AptComponent other ) {
    ...
    void setDistribution( AptDistribution distribution ) {
        this.distribution = distribution;
    }

    public AptDistribution getDistribution() {
        return distribution;
    }
    ...
    public boolean equals( Object obj ) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AptComponent other = (AptComponent)obj;
