...
public class DebMaker {
  ...
  public DebMaker(Console console, File deb, File controlDir) {
    this(console, deb, controlDir, null);
  }

  public DebMaker(Console console, File deb, File controlDir, Collection dataProducers) {
   ...
   * The new data source may point to a single file, a directory, or a tarball.
   *
   * @param file  The data source to add
   */
  public void addData(File file) {
    dataProducers.add(new Data(file));
  }
  ...
  public void makeDeb() throws PackagingException {
    ...
    if (control == null || !control.isDirectory()) {
      throw new PackagingException("You must specify a valid 'control' directory.");
    }
    ...
    final Processor processor = new Processor(console, null);
